...
\vfill
 {\bf Simon-Olivier Laperri\`ere, Robin Legault, and Pierre L'Ecuyer} \\ \ \\
\medskip
...
The module {\tt unit} contains functions to test the whole library by a single function call.
