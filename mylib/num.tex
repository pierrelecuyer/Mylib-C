...
\endcode
  ...
  One has {\tt num\_TwoExp[i]} $= 2^i$ for $0 \le i \le$ {\tt num\_MaxTwoExp}.
	\mpierre{Instead of storing the numbers, this could be replaced by a macro,
	 ...
	 One limitation: Does not work for $x \ge 64$.}
\endtab
\code
...
\endcode
  \tab Returns the smallest integer value between {\tt x} and {\tt y}.
	\mpierre{This function are the next three ones are deprecated.  
