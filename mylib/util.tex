...
\endcode
 ...
 \pierre{See also \url{https://bitbashing.io/comparing-floats.html} for more
  sophisticated comparison methods of floating-point numbers.}
 \endtab
\code

#define util_nearEqualDefault(x,y) util_nearEqualRel (x, y, 0.0000001)
\endcode
\tab  This macro permits one to invoke the previous function by using a default value for the bound \texttt{eps} on the relative error.
\endtab
\code
