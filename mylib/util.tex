...
#define util_nearEqualRel(x,y) util_nearEqualRel (x, y, 1.0e-12)
\endcode
\tab  This macro permits one to invoke the previous function by using a default
  value for the bound \texttt{eps} on the relative error.
\endtab
\code
