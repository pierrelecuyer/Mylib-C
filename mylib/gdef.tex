...
\endcode
  \tab   The recommendation is to leave this undefined. 
   \pierre{Deprecated.  Perhaps it should be removed altogether, or at least hidden.}
  ...
  \url{http://www.opengroup.org/onlinepubs/007904975/toc.htm}).
	...
	On Windows platforms, we use the 
   %(when the macro \texttt{HAVE\_WINDOWS\_H} is defined),
  MS-Windows function \texttt{GetProcessTimes} to measure
